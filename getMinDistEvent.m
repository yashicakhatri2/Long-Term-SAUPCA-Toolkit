function OUT = getMinDistEvent(t,S,constants,caseNumber,mu_old1,mu_old2)
    ...
    elseif caseNumber == 2
        ...
        if constants.STTOrder == 1
            ...
            STMf2{1} = reshape(S(81:end),dim,dim)';
        ...
        Out1{1} = [wrapToPi(Delf1(1:3)) Delf1(4:6)];
        Out2{1} = [wrapToPi(Delf2(1:3)) Delf2(4:6)];
        Out1{2} = STMf1;
        Out2{2} = STMf2;
    
        numericSTT1 = Out1{2};
        numericSTT2 = Out2{2};
        Del_updatedi1 =  Out1{1}(1:6)';
        Del_updatedi2 =  Out2{1}(1:6)';
