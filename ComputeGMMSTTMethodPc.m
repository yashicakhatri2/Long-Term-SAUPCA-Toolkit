    ...
    if constants.par == 0 
        ...
        for i = 1:jmax1
            for j = 1:jmax2
                ...
                mu_old1 = mu_old1i(:,i);            
                mu_old2 = mu_old2j(:,j);
                EventFun = @(t,S) CatchTCAGMMSTT(t,S,constants,mu_old1,mu_old2);
                doptions = odeset('RelTol', 1E-13,'AbsTol',1E-13,'Events',EventFun);

                [PC_GMMijthtot, GMM_mean] = FindTCAGMMSTTMethod(mu_old1, mu_old2, ICState, constants, doptions, Q_bar1_norm, Q_bar2_norm); 
                ...
                PC_GMM = PC_GMM + (w_bar1(i) * w_bar2(j)) * PC_GMMijthtot; % Total Pc calc: Sums up the weighed Pc for each individual GMM component
            end
        end
    else
        ...
        parfor i = 1:jmax1
            for j = 1:jmax2
                ...
                [PC_GMMijthtot,~] = FindTCAGMMSTTMethod(mu_old1, mu_old2, ICState, constants, doptions, Q_bar1_norm, Q_bar2_norm); 
